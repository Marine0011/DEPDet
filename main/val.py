...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='', help='training model path')
    parser.add_argument('--data', type=str, default='ultralytics/datasets/mydata.yaml', help='data yaml path')
    ...
    parser.add_argument('--split', type=str, default='val', choices=['train', 'val', 'test'], help='dataset_SSDD split to use for validation, i.e. val, test or train')
