...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode='train', batch=None):
        ...
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, rect=(True if mode == 'val' else False), stride=gs)
    ...
    def set_model_attributes(self):
        ...
        # TODO: self.model.class_weights = labels_to_class_weights(dataset_SSDD.labels, nc).to(device) * nc
