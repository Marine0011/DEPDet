...
class InfiniteDataLoader(dataloader.DataLoader):
    ...
    def reset(self):
        """Reset iterator.
        This is useful when we want to modify settings of dataset_SSDD while training.
        """
...
def load_inference_source(source=None, imgsz=640, vid_stride=1):
    ...
    Returns:
        dataset_SSDD (Dataset): A dataset_SSDD object for the specified input source.
    """
    ...
    # Attach source types to the dataset_SSDD
