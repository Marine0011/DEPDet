...
"""
Train a model on a dataset_SSDD
...
class BaseTrainer:
    ...
    Attributes:
        ...
        trainset (torch.utils.data.Dataset): Training dataset_SSDD.
        testset (torch.utils.data.Dataset): Testing dataset_SSDD.
    ...
    def check_resume(self):
        ...
        if resume:
            try:
                ...
                # Check that resume data YAML exists, otherwise strip to force re-download of dataset_SSDD
