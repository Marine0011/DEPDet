...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='', help='model.yaml path')
    ...
    parser.add_argument('--fraction', type=float, default=1.0, help='dataset_SSDD fraction to train on (default is 1.0, all images in train set)')
