---
comments: true
description: Discover the xView Dataset, a large-scale overhead imagery dataset_SSDD for object detection tasks, featuring 1M instances, 60 classes, and high-resolution images.
---
