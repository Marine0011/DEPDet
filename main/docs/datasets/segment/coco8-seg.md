---
comments: true
description: Test and debug segmentation models on small, versatile COCO8-Seg instance segmentation dataset_SSDD, now available for use with YOLOv8 and Ultralytics HUB.
---
