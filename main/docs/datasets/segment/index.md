---
comments: true
description: Learn about the Ultralytics YOLO dataset_SSDD format for segmentation models. Use YAML to train Detection Models. Convert COCO to YOLO format using Python.
---
