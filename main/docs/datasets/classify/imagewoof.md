---
comments: true
description: Learn about the ImageWoof dataset_SSDD, a subset of the ImageNet consisting of 10 challenging-to-classify dog breed classes.
---
...
```python
# For medium-sized dataset_SSDD
model.train(data='imagewoof320', epochs=100, imgsz=224)

# For small-sized dataset_SSDD
