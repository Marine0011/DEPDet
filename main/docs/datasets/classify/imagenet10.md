---
comments: true
description: Learn about the ImageNet10 dataset_SSDD, a compact subset of the original ImageNet dataset_SSDD designed for quick testing, CI tests, and sanity checks.
---
