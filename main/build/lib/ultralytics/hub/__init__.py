...
def check_dataset(path='', task='detect'):
    """
    Function for error-checking HUB dataset_SSDD Zip file before upload
    ...
    Usage
        ...
        check_dataset('path/to/coco8.zip', task='detect')  # detect dataset_SSDD
        check_dataset('path/to/coco8-seg.zip', task='segment')  # segment dataset_SSDD
        check_dataset('path/to/coco8-pose.zip', task='pose')  # pose dataset_SSDD
    """
    HUBDatasetStats(path=path, task=task).get_json()
    LOGGER.info('Checks completed correctly ✅. Upload this dataset_SSDD to https://hub.ultralytics.com/datasets/.')
