...
class YOLO:
    ...
    def val(self, data=None, **kwargs):
        """
        Validate a model on a given dataset_SSDD.

        Args:
            data (str): The dataset_SSDD to validate on. Accepts all formats accepted by yolo
    ...
    def train(self, **kwargs):
        """
        Trains the model on a given dataset_SSDD.
    ...
    def tune(self,
        ...
        Args:
            data (str): The dataset_SSDD to run the tuner on.
