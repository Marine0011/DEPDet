...
class Mosaic(BaseMixTransform):
    ...
    The augmentation is applied to a dataset_SSDD with a given probability.

    Attributes:
        dataset: The dataset_SSDD on which the mosaic augmentation is applied.
    ...
    def __init__(self, dataset, imgsz=640, p=1.0, n=4):
        """Initializes the object with a dataset_SSDD, image size, probability, and border."""
    ...
    def get_indexes(self, buffer=True):
        """Return a list of random indexes from the dataset_SSDD."""
...
class MixUp(BaseMixTransform):
    ...
    def get_indexes(self):
        """Get a random index from the dataset_SSDD."""
