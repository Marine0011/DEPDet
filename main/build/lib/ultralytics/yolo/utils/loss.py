...
class v8SegmentationLoss(v8DetectionLoss):
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset_SSDD incorrectly formatted or not a segment dataset_SSDD.\n'
                            "This error can occur when incorrectly training a 'segment' model on a 'detect' dataset_SSDD, "
                            "i.e. 'yolo train model=yolov8n-seg.pt data=coco128.yaml'.\nVerify your dataset_SSDD is a "
                            "correctly formatted 'segment' dataset_SSDD using 'data=coco128-seg.yaml' "
